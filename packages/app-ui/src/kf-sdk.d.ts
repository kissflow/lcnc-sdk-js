// The published @sooryakanth/lowcode-client-sdk ships bundled *ambient* typings
// (its default export lives in an internal `declare module "index"` block), so
// `import KFSDK from "@sooryakanth/lowcode-client-sdk"` isn't consumable as a module
...
declare module "@sooryakanth/lowcode-client-sdk" {
  interface KfPage {
