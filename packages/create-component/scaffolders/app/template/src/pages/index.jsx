import { usePageTitle } from "@sooryakanth/app-ui";
import { Area, AreaChart, CartesianGrid, XAxis } from "recharts";
import { ArrowUpRight, CheckCircle2, Clock, FileText, Plus, TrendingUp, Users } from "lucide-react";
...
const RECENT = [
  { id: "REC-1042", title: "Quarterly review", owner: "A. Sharma", status: "Active" },
  { id: "REC-1041", title: "Vendor onboarding", owner: "M. Iyer", status: "Pending" },
  { id: "REC-1039", title: "Budget approval", owner: "K. Rao", status: "Completed" },
  { id: "REC-1036", title: "Site inspection", owner: "S. Nair", status: "Active" },
];

const STATUS_VARIANT = { Active: "default", Pending: "secondary", Completed: "outline" };
    ...
    <div className="mx-auto max-w-6xl space-y-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Overview of your app's activity.</p>
        </div>
      ...
      <div className="grid gap-4 lg:grid-cols-3">
          ...
          <CardContent>
            <ChartContainer config={chartConfig} className="h-[240px] w-full">
              <AreaChart data={ACTIVITY} margin={{ left: 4, right: 4, top: 8 }}>
                ...
                <Area dataKey="created" type="natural" stroke="var(--color-created)" fill="var(--color-created)" fillOpacity={0.2} stackId="a" />
                <Area dataKey="closed" type="natural" stroke="var(--color-closed)" fill="var(--color-closed)" fillOpacity={0.2} stackId="a" />
              </AreaChart>
            </ChartContainer>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Share of open records.</CardDescription>
          </CardHeader>
