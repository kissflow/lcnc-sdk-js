...
export function TableUserSelectField({
  field,
  value,
  onChange,
  onBlur,
  ...
  return (
    ...
    >
      <SelectTrigger className="h-8 text-sm px-2 border-border bg-background focus:ring-1 focus:ring-ring w-full min-w-[120px]">
